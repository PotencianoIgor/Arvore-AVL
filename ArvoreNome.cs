...
namespace Arvore
{
    public class ArvoreNome
    {
        ...
        private void Inserir(No raiz, Pessoa dadosPessoa, out No novaRaiz)
        {
            ...
            if (raiz != null)
            {
                if (dadosPessoa.Nome.CompareTo(raiz.DadosPessoa.Nome) < 0)
                {
        ...
        private void Buscar(string nome, No raiz, ref List<Pessoa> pessoas)
        {
            if (raiz != null)
            {
                if (raiz.DadosPessoa.Nome.StartsWith(nome))
                {
                    pessoas.Add(raiz.DadosPessoa);
                    Buscar(nome, raiz.NoDireita, ref pessoas);
                    Buscar(nome, raiz.NoEsquerda, ref pessoas);
                }
                else
                {
                    if (nome.CompareTo(raiz.DadosPessoa.Nome) < 0)
                    {
                        Buscar(nome, raiz.NoEsquerda, ref pessoas);
                    }
                    else
        ...
        public List<Pessoa> Buscar(string nome)
        {
            if (NoRaiz != null)
            {
                ...
                Buscar(nome, NoRaiz, ref pessoas);
                if (pessoas.Count == 0)
                {
